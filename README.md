...
## 🏛️ 三大都护府规划矩阵 (The Three Grand Protectorates)

为确保与游戏原版及历史剧本完全解耦，本 Mod 采用纯独立头衔设计（安东大都护府独立定义，绝不复用或覆写原版泛辽东 e_andong，确保契丹/辽剧本 100% 零冲突），并配备官方天朝古典金石印玺篆章：

| 大都护府 | 头衔代码 | 法理首都与治所 | 前置领地解锁条件 | 统摄地理方向 | 官制与政体 |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **安西大都护府** | `e_anxi_protectorate` | **高昌** (`c_kara_khoja`) | 统辖**高昌**伯爵领 | 西域、河中、中亚绿洲、波斯、吐蕃诸邦 | 天朝都护行省契约 · 总督委任法 |
| **安东大都护府** | `e_andong_protectorate` | **沈阳** (`c_LIAO_shenyang`) | 统辖**沈阳**伯爵领 | 辽东、朝鲜半岛诸国、扶桑群岛 | 天朝都护行省契约 · 总督委任法 |
| **安北大都护府** | `e_anbei_protectorate` | **哈喇和林** (`c_karakorum`) | 统辖**哈喇和林草原**伯爵领 | 蒙古大漠草原、贝加尔、西伯利亚冻原诸部 | 天朝都护行省契约 · 总督委任法 |
...
```mermaid
flowchart TD
    A[天朝天子霸权] -->|决议原生挂件选择| B(天子敕建：大都护府事务)
    B --> C{选择设府或管理}
    C -->|安西 / 安东 / 安北| D[呼出专属管辖多选面板]
